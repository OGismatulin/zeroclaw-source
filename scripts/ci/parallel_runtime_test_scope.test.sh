...
expect_cargo_log "channels scope" \
    'test --locked --quiet -p zeroclaw-channels --lib -- --test-threads=16 --skip observability::runtime_trace::tests::legacy_record_event_writes_legacy_shape_and_rolls --skip tools::scoped::tests::assemble_emits_one_mcp_connect_failure_per_failed_boot_connect'
...
expect_cargo_log "default scope" \
    'test --locked --quiet -p zeroclaw-runtime --lib -- --test-threads=16 --skip observability::runtime_trace::tests::legacy_record_event_writes_legacy_shape_and_rolls --skip tools::scoped::tests::assemble_emits_one_mcp_connect_failure_per_failed_boot_connect' \
    'test --locked --quiet -p zeroclaw-channels --lib -- --test-threads=16 --skip observability::runtime_trace::tests::legacy_record_event_writes_legacy_shape_and_rolls --skip tools::scoped::tests::assemble_emits_one_mcp_connect_failure_per_failed_boot_connect'
